...
public class InventoryTypes {
    ...
    public static final InventoryType BAUBLES = new Inventory("baubles") {

        @Override
        public boolean isActive() {
            return ModularUI.isBaublesLoaded;
        }

        @Override
        public IInventory getInventory(EntityPlayer player) {
            if (isActive()) {
                //return BaublesApi.getBaubles(player); // this shit is so damn cursed, it used reflection on itself
