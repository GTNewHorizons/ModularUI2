...
public class CompoundKey extends BaseKey {
    ...
    @Override
    public String getFormatted(EnumChatFormatting @Nullable [] parentFormatting) {
        // formatting is prepended to each key
        return toString(true, parentFormatting);
    }

    private String toString(boolean formatted, EnumChatFormatting @Nullable [] parentFormatting) {
