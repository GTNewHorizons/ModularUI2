...
public class FormattingState {
    ...
    private EnumChatFormatting reset;
    private EnumChatFormatting color;
    private EnumChatFormatting underline;
    private EnumChatFormatting italic;
    private EnumChatFormatting bold;
    private EnumChatFormatting strikethrough;
    private EnumChatFormatting obfuscated;
    ...
    public void add(EnumChatFormatting formatting, boolean removeAllOnReset) {
    ...
    private static void prependText(FormattingState state,
                                    ...
                                    Function<FormattingState, EnumChatFormatting> getter,
