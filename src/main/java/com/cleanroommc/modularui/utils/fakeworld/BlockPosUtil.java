...
public class BlockPosUtil {
    ...
    public static void setMin(BlockPos p1, BlockPos p2) {
        p1.set(Math.min(p1.getX(), p2.getX()), Math.min(p1.getY(), p2.getY()), Math.min(p1.getZ(), p2.getZ()));
    }

    public static void setMax(BlockPos p1, BlockPos p2) {
    ...
    public static Vector3d getCenterD(BlockPos p1, BlockPos p2) {
    ...
    public static Vector3d getCenterD(BlockPos origin, int xs, int ys, int zs) {
        return new Vector3d(xs / 2.0 + origin.getX(), ys / 2.0 + origin.getY(), zs / 2.0 + origin.getY());
    }
    ...
    public static Iterable<BlockPos> getAllInside(BlockPos p1, BlockPos p2, boolean includeBorder) {
        ...
        return BlockPos.getAllInBox(x0, y0, z0, x1, y1, z1);
    }
